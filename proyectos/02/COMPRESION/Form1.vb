    ...
    Private Sub ButtonARCHIVOCOM_Click(sender As Object, e As EventArgs) Handles ButtonARCHIVOCOM.Click
        Try
            If OpenFileDialog1.ShowDialog = Windows.Forms.DialogResult.OK Then
                ...
                If (File.GetAttributes(ARCHIVO.FullName) And FileAttributes.Hidden) <> FileAttributes.Hidden And ARCHIVO.Extension <> ".gz" Then
                    Using COMPRIMIDO As FileStream = File.Create(ARCHIVO.FullName + ".gz")
