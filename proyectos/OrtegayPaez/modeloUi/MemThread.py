...
Lectura: Hilo único que leerá un archivo y lo transformará en una lista de strings para su posterior utilización
Escritura: Hilo que lanza 3 hilos muy parecidos que iteran sobre la lista obtenida, trasnforman el tipo de dato
